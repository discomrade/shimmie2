        ...
        if ($event->page_matches("perm_manager/{class}/set_parent", method: "POST", permission: Permissions::MANAGE_PERMISSION_LIST)) {
            ...
            if ($class == only_strings($event->POST)["name"]) {
                ...
                if ($success) {
                    ...
                    throw new InvalidInput("Cannot delete a core class or a class which is a parent.");
                }
            } else {
                throw new InvalidInput("The class name did not match.");
            ...
            if ($success) {
                ...
                throw new InvalidInput("The class name was invalid.");
