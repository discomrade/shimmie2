...
class PermManagerTest extends ShimmiePHPUnitTestCase
{
    ...
    public function test_duplicate_class(): void
    {
        ...
        $this->log_in_as_admin();
        $e = $this->assertException(InvalidInput::class, function () {
            $page = $this->post_page("perm_manager/new", ["new_name" => "user", "new_parent" => "base"]);
        });
        $this->assertStringContainsString("class name was invalid", $e->getMessage());
    ...
    public function test_modify_class(): void
    {
        ...
        //        var_dump(UserClass::$known_classes["test1"]->name);
    ...
    public function test_delete_class(): void
    {
        ...
        $this->assertStringContainsString("did not match", $e->getMessage());
        ...
        $this->assertStringContainsString("core class or a class which is a parent", $e->getMessage());
